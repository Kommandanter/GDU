...
NDefines.NCountry.EVENT_PROCESS_OFFSET = 25 -- Performance enhancer.
...
NDefines.NMilitary.UNIT_LEADER_ASSIGN_TRAIT_COST = 0.00 -- Assigning traits is a PITA. Why should it cost anything? Let's use CP in the field where it's more interesting. 
...
NDefines.NAir.ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 0.90 -- original 1.00 Balancing value to convert equipment stat anti_air_attack to the damage reduction modifier apply to incoming air attacks against units with AA.
...
NDefines.NNavy.ANTI_AIR_TARGETTING_TO_CHANCE = 0.06 --Original in PFU: 0.1. In vanilla, 0.07 Balancing value to convert averaged equipment stats (anti_air_targetting and naval_strike_agility) to probability chances of airplane being hit by navies AA... Maybe.
NDefines.NNavy.ANTI_AIR_ATTACK_TO_AMOUNT = 0.001 -- Original in PFU: 0.01. 0.005 in vanilla. Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit. 
